...
-- Give created_at a default so strict-mode INSERTs without it work
ALTER TABLE `interview_questions` MODIFY COLUMN `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP;
