...
VALUES
(2, 'RIASEC职业兴趣', 'Holland职业兴趣测评，探索你的实际型(R)、研究型(I)、艺术型(A)、社会型(S)、企业型(E)、常规型(C)倾向', 12, 1, 1, 1),
(3, '大五人格(BIG5)', '测量开放性(O)、尽责性(C)、外向性(E)、宜人性(A)、神经质(N)五大人格维度', 10, 1, 1, 1),
(4, '职业价值观', '了解你最看重的职业价值维度：成就感、安全感、自主性、社会服务、地位声望、多样挑战', 12, 1, 1, 1),
(5, '压力应对测评', '评估你在压力情境中的应对风格和情绪调节模式', 10, 1, 1, 1),
(6, '团队角色测评', '基于Belbin模型，识别你在团队中最自然的角色：领导者、推进者、协调者、创意者、执行者', 10, 1, 1, 1);
