...
public class DataLoaderConfig {
    ...
    private void seedHomeArticles(HomeArticleRepository repo) {
        ...
        repo.save(HomeArticle.builder()
                ...
                .imageUrl("https://pic2.zhimg.com/v2-8c8b8e8b8e8b8e8b8e8b8e8b8e8b8e8b_720w.jpg")
                .sourceUrl("https://zhuanlan.zhihu.com/p/684500000")
                .category("skill")
        ...
        repo.save(HomeArticle.builder()
                ...
                .imageUrl("https://pic3.zhimg.com/v2-9d9c9d9c9d9c9d9c9d9c9d9c9d9c9d9c_720w.jpg")
                .sourceUrl("https://zhuanlan.zhihu.com/p/658000000")
                .category("interview")
                .publishedAt(now.minusDays(1))
                .build());
        repo.save(HomeArticle.builder()
                .title("校招简历的 3 个致命伤，AI 诊断告诉你怎么改")
                .summary("最常见的「项目经历堆砌」「岗位错配」「关键词缺失」，看看你中了哪条。")
                .imageUrl("https://pic1.zhimg.com/v2-7b7a7b7a7b7a7b7a7b7a7b7a7b7a7b7a_720w.jpg")
                .sourceUrl("https://zhuanlan.zhihu.com/p/670000000")
                .category("resume")
        ...
        repo.save(HomeArticle.builder()
                ...
                .imageUrl("https://pic4.zhimg.com/v2-6a6b6a6b6a6b6a6b6a6b6a6b6a6b6a6b_720w.jpg")
                .sourceUrl("https://zhuanlan.zhihu.com/p/651000000")
                .category("planning")
        ...
        repo.save(HomeArticle.builder()
                ...
                .imageUrl("https://pic2.zhimg.com/v2-5c5d5c5d5c5d5c5d5c5d5c5d5c5d5c5d_720w.jpg")
                .sourceUrl("https://zhuanlan.zhihu.com/p/640000000")
                .category("planning")
    ...
    private void seedHomeConsultations(HomeConsultationRepository repo) {
        ...
        repo.save(HomeConsultation.builder()
                ...
                .sourceUrl("https://www.zhihu.com/question/29695075")
        ...
        repo.save(HomeConsultation.builder()
                ...
                .sourceUrl("https://www.zhihu.com/question/385672014")
                .publishedAt(now.minusDays(2))
                .build());
        repo.save(HomeConsultation.builder()
                ...
                .sourceUrl("https://www.zhihu.com/question/41781100")
                .publishedAt(now.minusDays(4))
                .build());
    }
